...
incn:
    mov r10,#10            
	mul r11,r10,r11      @ n= 10 * n
	cmp r11,#0
	addge r11,r11,r9
	sublt r11,r11,r9       @ n = 10 *n + newdigit
	b assignloop
...
evaluate:
    ...
    addeq r3,r3,r2
	cmp r10,#13
	subeq r3,r3,r2   @operand2 - operand1
	cmp r10,#14
	muleq r3,r2,r3
	cmp r10,#15
	beq divide           @bl if equal   operand2/operand1
	dividedone:
